        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-base-content/70 leading-relaxed max-w-xl">
              ...
              programming. Connect face-to-face, code in real-time, and ace yout
            ...
            <div className="stats stats-vertical lg:stats-horizontal bg-base-100 shadow-lg">
              ...
              <div className="stat">
                <div className="stat-value text-secondary">99K+</div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-content/70">
                Crytal clear video and audio for seamless communication during
                interviews
              </p>
            </div>
          </div>
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-contenr/70">
